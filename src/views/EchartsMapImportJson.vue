    ...
    export default {
        ...
        methods: {
            ...
            clickMapChart (event, instance, ECharts) {
                ...
                switch (event.name) {
                    case '安徽':
                        this.provinceMapOption.geo[0].map = 'anhui'
                        this.provinceMapOption.series[0].map = 'anhui'
                        this.showChinaMap = false
                        break
                    case '山东':
                        this.provinceMapOption.geo[0].map = 'shandong'
                        this.provinceMapOption.series[0].map = 'shandong'
                        this.showChinaMap = false
                        break
                }
            },
